...
Comme vu dans l'[état de l'art](./README.md#movements), il serait préférable de désactiver composant **movement-controls** en VR  et implémenter un autre système de déplacement comme la téléportation (nous le ferons dans la suite de ce TP). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MzM5OTI2NjAsLTI0NzgwNzcwNCwtMj

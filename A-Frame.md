...
Ajoutez une méthode [update](https://aframe.io/docs/1.0.0/core/component.html#update-olddata) à votre composant. Elle devra être capable de gérer les changements de tous les attributs requis de votre primitive, c'est à dire de **size**, **color**, **cellsize** et **height**.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NTMxODg2MzMsMTE0NTMwNDIxNSwtMT

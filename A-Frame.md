...
Comme vu dans l'[état de l'art](./README.md#movements), il serait préférable de désactiver composant **movement-controls** en VR  et implémenter un autre système de déplacement comme la téléportation (nous le ferons dans la suite de ce ). Vous pouvez ainsi n'utiliser que **keyboard-controls**, **touch-controls** et **gamepad-controls**. Si un utilisateur veut vraiment utiliser le mode de déplacement libre en VR, il peut le faire avec un *gamepad*. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMTUwMzU1NDUsLTI0NzgwNzcwNCwtMj

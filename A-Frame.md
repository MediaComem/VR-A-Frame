...
L'implémentation des *nav-mesh* va être grandement simplifié par le fait qu'**aframe-extras** offre sa gestion. Le principale problème restant sera de générer des *nav-mesh* en accord avec notre scène VR.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NDc2MTM5MzQsMTU0MzYzMjM1MywxMT

...
- **Glare et "God rays"**:  En cas de scène à fort forts contrastes, les couleurs clair (le blanc principalement) "bave". On voit comme des rayons lumineux (God Rays). La cause: es lentilles Fresnel utilisé dans dans le casques. Solution: limiter les forts contrastes dans les scènes VR.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkzMDIzNDQ0NywtMTA3NzU3Nzk0NywtMz

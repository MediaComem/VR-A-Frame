...
- **Espaces VR** pensés pour que l'utilisateur revienne sur ses pas, et reste dans un espace restreint (identique à son espace réelle). Ce peut être fait avec l'utilisation d'ascenseurs, des techniques de chevauchement (*overlapping*) d'espaces (voir image), ou autres astuces (désorientations, fauss). L’expérience (*jeu*) [Unseen Diplomacy](https://store.steampowered.com/app/429830/Unseen_Diplomacy/)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxNDQ2NzUzOCwxNTU2OTA4MDI0LDE5Nz

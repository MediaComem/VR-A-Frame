...
- **Espaces VR** pensés pour que l'utilisateur revienne sur ses pas, et reste dans un espace restreint (identique à son espace réelle). via par exemple des techniques  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYzODAzMTI3LDE1NTY5MDgwMjQsMTk3MD

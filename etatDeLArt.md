...
Toutefois, même si l'espace VR est plus grand que l'espace réel, il existe quelques méthodes (*astuces*) pour éviter de devoir déplacer la caméra de l'utilisateur ou d'utiliser des mécanisme de télport:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3ODc2MjEzNCwxNDgxOTkyODQ1LC05ND

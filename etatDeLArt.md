...
- **[Le foveated rendering](https://en.wikipedia.org/wiki/Foveated_rendering)**: seul le centre de l'image est calculé en haute définition et La résolution diminue de plus en plus en périphérie. Avec du eye-tracking intégré aux casques cela pourrait être d'autant plus performant. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5ODc0MjAyMTEsLTIwNTAyMTk0NjIsLT
